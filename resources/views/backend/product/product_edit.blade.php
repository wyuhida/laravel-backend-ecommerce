                                    ...
                                    <div class="border border-3 p-4 rounded">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select name="subcategory" class="form-select" id="inputProductType">
                                                    ...
                                                    @foreach($subcategory as $item)
                                                        <option value="{{ $item->subcategory_name }}" {{$item->subcategory_name == $product->subcategory ? 'selected' : ''}}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" name="remark" type="checkbox" value="FEATURED" 
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" name="remark" type="checkbox" value="COLLECTION" 
